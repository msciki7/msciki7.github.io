...
&ensp;키 입력을 받으려면 포커스 필수:<br/>
```java
component.setFocusable(true);
component.requestFocus(); // setVisible(true) 이후 호출 권장
```

&ensp;키 이벤트를 받을 수 있는 조건<br/>
* 모든 컴포넌트 가능하지만 현재 포커스(focus)를 가진 컴포넌트

&ensp;포커스(focus)<br/>
* 컴포넌트나 응용프로그램이 키 이벤트를 독점하는 권한

&ensp;컴포넌트에 포커스 주기<br/>
&ensp;스윙 프레임이 만들어질 포커스를 주고자 하는 경우<br/>
...
&ensp;마우스로 컴포넌트를 클릭할 때 포커스 지정하는 방법<br/>
