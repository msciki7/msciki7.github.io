...
&ensp;Iteration 0 (초기값)<br/>
* Remainder = 00001 10001 (49)
* Divisor = 00101 (5)
* Quotient = 00000 (아직 없음)

&ensp;Iteration 1<br/>
1. Remainder shift left → 00011 10010
2. 현재 Rem ≥ 0 → Divisor 빼기
  - 00011 10010 – 00101 = (양수)
  - 성공!
3. Quotient 비트 = 1
...
&ensp;Iteration 2<br/>
1. Remainder shift left
2. 직전 결과가 양수였으니 다시 빼기 시도
  - 빼니까 음수 나옴 → 실패
  - 대신 Divisor를 다시 더해 복원
3. Quotient 비트 = 0
...
&ensp;Iteration 3<br/>
1. Remainder shift left
2. 다시 Divisor 빼기 시도 → 이번엔 양수 유지
3. Quotient 비트 = 1

&ensp;Quotient = 101..<br/>
...
&ensp;Quotient = 1011.<br/>

&ensp;Iteration 5 (마지막)<br/>
* 과정을 끝까지 반복하면, 최종 Quotient = 1001 (십진수 9)
* Remainder = 0100 (십진수 4)

&ensp;최종 결과<br/>
* Quotient = 9
* Remainder = 4

&ensp;따라서 49 ÷ 5 = 9…4<br/>
