...
&ensp;3. 저장 장치 관리(Storage Mangagement)<br/>
============
...
&ensp;4. 입출력 구조(I/O Structure)<br/>
=========
...
&ensp;10. 자원 관리(Resource Management)<br/>
=======
...
&ensp;11. 파일 시스템 관리(File System Management)<br/>
======
...
&ensp;12. 입출력 시스템 관리(I/O Systems Management)<br/>
======
...
&ensp;13. 보안과 보호(Security and Protection)<br/>
...
&ensp;15. 분산 시스템(Distributed Systems)<br/>
...
&ensp;16. 커널 자료구조(Kernel Data Structures)<br/>
...
&ensp;17. 계산환경(Computing Environments)<br/>
...
&ensp;18. 피어 간 계산(Peer-to-Peer Computing)<br/>
...
&ensp;19. 무료 및 공개 소스 운영체제(Free and Open-Source Operating Systems)<br/>
