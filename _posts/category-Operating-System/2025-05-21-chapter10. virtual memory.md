...
<p align="center"><img src="/assets/img/Operating System/10. virtual memory/10-46png" width="600"></p>
...
&ensp;성능을 좋게 하려면? <br/>
* **CPU1에서 실행되는 스레드(thread)**는 CPU1과 가까운 메모리를 쓰게 해야 빨라요.
&ensp;그래서 운영체제는 다음과 같은 일을 한다. <br/>
1. 스레드가 어떤 CPU에서 실행될지 정하고
2. 그 CPU와 가까운 메모리를 할당해줘요.
